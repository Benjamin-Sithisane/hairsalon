      ...
      <div class="container">
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            ...
            <form action="StudentControllerServlet" method="GET" class="bg-light p-5 contact-form">
              ...
              <div class="form-group">
                <input type="text" name="email" class="form-control" placeholder="Email">
           	  ...
           	  <div class="form-group">
              	...
              	<button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" class="save">Add Customer</button>
              </div>	
            </form>
          </div>
        </div>
